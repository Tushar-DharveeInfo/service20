...
import '../shared/allcss/FqaNotes.css'
import '@n20a/libavnotes/style.css'
import { IAppQaContactUs } from "./allinterface/IAppQaContactUs.ts"
...
import type { INoteItems } from "../shared/allinterface/sidebar/IFqaNotes.ts"
import { sampleNotesEntityRecordsResponse } from "../../sampledata/sidebar/NotesSampleData.ts"
    ...
    useEffect(() => {
        ...
        const sampleNotes =
            typeof parsedData === "object"
                ...
                ? (parsedData as Record<string, INoteItems[]>)["PG.Notes"]
                : [];
...
const AppQaContactUs = (contactUsProps: IAppQaContactUs) => {
