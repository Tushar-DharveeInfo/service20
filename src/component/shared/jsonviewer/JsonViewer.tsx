import { IJsonViewer } from '../allinterface/IJsonViewer';
import '../allcss/JsonViewer.css';
import { ActionImage } from '../basic/actionimage/ActionImage';
import { Copy24x24 } from '@n20a/libicon';
import { FnGetCssVariable } from '../../appcontainer/allcommon/FnGetCssVariable';
import { JsonTreeView } from '@n20a/libreport';
...
const JsonViewer = (props: IJsonViewer) => {
    ...
    return (
        ...
        >
            ...
            <div className='nz-json-view-content'>

                {props.showAsDiv ? <pre className="nz-json-pre">
                    {JSON.stringify(formattedJson, undefined, 2)}
                </pre> : <JsonTreeView data={formattedJson} />}
