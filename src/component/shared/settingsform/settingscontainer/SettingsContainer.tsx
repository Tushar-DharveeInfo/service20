...
import { useAppqaSettingsVarContext } from '../../context/hooks/AppqaSettingsVarHooks.ts';
import { useStatusBarContext } from '../../context/hooks/StatusBarHooks.ts';
import { axiosInterceptor } from '../../interceptors/Interceptor.ts';
import '../../allcss/settingsform/SettingsContainer.css';
import { AP, MISC } from '../../interceptors/EndPoints.ts';
...
import { ISettingsContainer } from '../../allinterface/settingsform/ISettingsContainer.ts';
import { IControl } from '../../allinterface/settingsform/ISettingsLibForm.ts';
...
const SettingsContainer = (formContainerProps: ISettingsContainer) => {
    ...
    const appqaSettingsContext = useAppqaSettingsVarContext();
    ...
    }, [formControls, actionLabelItems, subGroup, allowActionList, appqaSettingsContext?.selectedProfileItem, optionalFromControls]);
